<x-layout>
    ...
    <x-job-card :$job>
        ...
        @can('apply',$job)
        <x-link-button :href="route('job.application.create',$job)" class="w-full">Apply</x-link-button>
        @else
    ...
    <x-card class="mb-4">
        <h2 class="mb-4 text-lg font-medium"> Exlpore more Jobs by {{$job->employer->company_name}}</h2>
